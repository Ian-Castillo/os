        ...
        {activeSection === 'about' && (
          <>
            <div className="work-experience">
              ...
              <p>Previously, I was a Product Manager & Designer at <button onClick={() => window.open('https://riiid.com', '_blank')} className="nav-button">Riiid Labs</button>, where I facilitated advancements in AI-driven education applications. While on the LX team, I collaborated with AI researchers, engineers, and designers, driving forward projects that utilized Machine Learning and LLMs to enhance learning outcomes. My work centered on developing digital products that personalized education through artificial intelligence, making learning more accessible and effective for students worldwide.</p>
              <p>Outside of my day job, i'm trying to help reverse the clusterfuck that is extreme climate change. I founded <button onClick={() => window.open('http://sunnyweather.co', '_blank')} className="nav-button">Sunny Weather</button> an AI-powered platform that transforms how people understand and interact with weather information. The mission is to empower individuals with personalized insights into how climate change affects their local communities, turning daily weather forecasts into opportunities for learning, preparation, and community resilience. If I can bridge the gap between global climate trends and hyperlocal weather impacts, Sunny Weather wont just predict the weather, it'll foster a more climate-conscious and proactive society.</p>
              <p>I'm at capacity at the moment working on my own projects, but I'm always interested in connecting with other builders/designers/developers. If thats you, let's connect and explore re-imagining the future.</p>
              {renderSocialIcons()}
            </div>
          </>
        )}
