        ...
        {activeSection === 'about' && (
          <>
            <div className="work-experience">
              ...
              <p>Outside of my day job, I’m tackling the climate crisis by rethinking how people interact with weather data through <button onClick={() => window.open('http://sunnyweather.co', '_blank')} className="nav-button">Sunny Weather</button>, an AI-powered platform. Traditional weather apps offer broad, impersonal forecasts, leaving users disconnected from how weather truly impacts their daily lives. Sunny Weather delivers personalized insights that reflect the realities of our changing climate, helping users anticipate and adapt to increasingly unpredictable conditions. Beyond just forecasting, our platform fosters community engagement, turning weather data into dynamic conversations that empower individuals to build resilience in the face of climate change. </p>
